...
class JssdkController extends Controller
{
  ...
  {
    $respose = new Response();
    $ids = $this->container->getParameter('wechat_jssdkids');
    if(!in_array($fid, $ids) && $fid != '60c4349e-c302-4313-9fa8-37a8ebd59853')
    ...
    $jscode = array(
      ...
      'appId' => $jssdk['jssdk']['appid'],
      'timestamp' => $jssdk['jssdk']['time'],
      'nonceStr' => $jssdk['jssdk']['noncestr'],
      'signature' => $jssdk['jssdk']['sign'],
      'jsApiList' => $this->container->getParameter('wechat_jscode_allowapi'),
    );
    $wechajs =<<<EOF
